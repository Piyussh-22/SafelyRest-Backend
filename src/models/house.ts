// Defines the House model with validations, relationships, and middleware to clean up related favourites when a house is deleted.
...
const houseSchema = new Schema<IHouse>(
  {
    ...
    amenities: [{ type: String, enum: VALID_AMENITIES }],
    capacity: {
      type: Number,
...
const deleteFavourites = async (houseId: mongoose.Types.ObjectId) => {
