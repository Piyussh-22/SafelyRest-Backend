// Handles admin operations like fetching dashboard stats, managing bookings with pagination, and deleting houses with related data cleanup.
...
export const removeHouseByAdmin = async (houseId: string) => {
